...
JsKoansReporter.prototype.reportSpecResults = function(spec) {
  ...
  if ( !results.passed() ) {
    ...
    description = "It " + spec.description + ". Don't worry, it is just sprinkling stardust on your karma."
  } else {
    description = "Knowing it " + spec.description + " has blissfully expanded your awareness."
  }
